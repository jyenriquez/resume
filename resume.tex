% !TEX root = relative/or/absolute/path/to/root/resume.tex
...
\begin{center}
    {\Huge \scshape Jacob Y. Enriquez} \\ \vspace{1pt}
    \small \raisebox{-0.1\height}\faPhone\ 484-467-8092 ~ \href{mailto:jyenriquez@gmail.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{jyenriquez@gmail.com}} ~ 
    \href{https://linkedin.com/in//}{\raisebox{-0.2\height}\faLinkedin\ \underline{linkedin.com/in/username}}  ~
    \href{https://github.com/jyenriquez}{\raisebox{-0.2\height}\faGithub\ \underline{github.com/jyenriquez}}
    \vspace{-8pt}
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {University of Pittsburgh}{Aug. 2018 -- April 2022}
      {Bachelor of Science in Computer Science; GPA 3.65}{Pittsburgh, Pennsylvania}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        and unit tests for Buyer Monitoring and Troubleshooting. Responsible for helping users understand what they spend on
